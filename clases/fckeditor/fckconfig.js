...
FCKConfig.ToolbarSets["Basic"] = [
	['Cut','Copy','Paste','PasteWord','SpellCheck','Bold','Italic','Underline','Superscript','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Link','Unlink','Image','Smiley','FontSize','TextColor','BGColor']
];
	
FCKConfig.ToolbarSets["Titulo"] = [
	['SpellCheck','Bold','Italic','Underline','JustifyCenter','Smiley','SpecialChar','FontName','FontSize','TextColor','BGColor']
];

FCKConfig.ToolbarSets["Pequenia"] = [];
