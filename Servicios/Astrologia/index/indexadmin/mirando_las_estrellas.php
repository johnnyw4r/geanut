...
?>
<span class="titulo_pri">Mirando las Estrellas</span>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div align="left" class="titulo"><strong>Titulo</strong></div></td>
  </tr>
  <tr>
    <td><div align="left">
    <?php
    $titulo_pensamiento=new FCKeditor('titulo_mirando_estrellas');
...
// $oFCKeditor->BasePath = '/fckeditor/' ;	// '/fckeditor/' is the default value.
	...
	$titulo_pensamiento=new FCKeditor('mirando_las_estrellas');
    $titulo_pensamiento->BasePath= '../../../../clases/fckeditor/';
    $titulo_pensamiento->Width='77%';
...
?>
  ...
  <tr>
    <td>
	<?php
    	$titulo_pensamiento=new FCKeditor('pie_mirando_las_estrellas');
    	$titulo_pensamiento->BasePath= '../../../../clases/fckeditor/';
    	$titulo_pensamiento->Width='77%';
    	$titulo_pensamiento->Height='50';
		$titulo_pensamiento->ToolbarSet='Basic';
